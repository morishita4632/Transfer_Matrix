...
int main() {
  ...
  sprintf (buff_Js, "./out/Xsquare/%d_%d_%d_%d_Js_.txt", Js_range[0], Js_range[1], Js_range[2], Js_range[3]); ////////////////////////
  sprintf (buff_Js_raw, "./out/Xsquare/%d_%d_%d_%d_Js_raw_.txt", Js_range[0], Js_range[1], Js_range[2], Js_range[3]); ////////////////////////
  sprintf (buff_Tc, "./out/Xsquare/%d_%d_%d_%d_Tc_.txt", Js_range[0], Js_range[1], Js_range[2], Js_range[3]); ////////////////////////
